...
export const ResultDescriptionMap = {
  ...
  190: '만약 당신의 점수가 190이하라면 회복탄력성을 높이기 위해 노력하는 것이 좋다.',
  180: '180점 이하라면 당신은 자그마한 부정적인 사건에도 쉽게 영향 받는 나약한 존재다. 당신은 되튀어오를 힘을 빨리 길러야 한다.',
  170: '170점 이하라면 당신은 깨지기 쉬운 유리 같은 존재라 할 수 있다. 크고 작은 자그마한 불행에도 쉽게 상처를 입게 되며 그 상처는 쉽게 치유되지 않을 것이다. 하루하루를 살얼음 위를 걷는 기분으로 살아온 당신은 지금 당장 회복탄력성을 높이기 위해 온 힘을 기울어야 한다.',
  200: '만약 당신의 점수가 200점을 넘는다면 일단 안심이다. 그러나 212점 정도는 돼야 상위 20%에 들 수 있다.',
  220: '220점을 넘는다면 당신은 대단히 회복탄력성이 높은 사람이다. 웬만한 불행한 사건은 당신을 흔들어 놓지 못한다. 오히려 역경은 당신을 더 높은 곳으로 올려놓기 위한 스프링보드이니 즐겁게 받아들일 일이다.',
};
